...
export PY_TO_INSTALL=$PY_TO_INSTALL

# Export variables for TMUX
if [[ -v TMUX_PANE_SEPERATOR_COLOR ]]; then
    export TMUX_PANE_SEPERATOR_COLOR=$TMUX_PANE_SEPERATOR_COLOR
else
    export TMUX_PANE_SEPERATOR_COLOR=$HOST_INDICATOR_COLOR
fi
